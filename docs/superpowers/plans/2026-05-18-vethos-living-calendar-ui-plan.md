...
**Référence spec :** `docs/superpowers/specs/2026-05-18-vethos-auto-placement-engine-design.md`. Partie A : `docs/superpowers/plans/2026-05-18-vethos-placement-engine-plan.md`.
...
Et juste après l'import de `vethos` :
