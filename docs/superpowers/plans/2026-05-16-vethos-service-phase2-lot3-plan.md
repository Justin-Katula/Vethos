...
Réf. spec : `docs/superpowers/specs/2026-05-15-vethos-windows-service-design.md` §4, §6.
...
- Migrer les fichiers de blocage vers `C:\ProgramData\Vethos`.
...
`\\.\pipe\VethosServiceBridge` et constater que le blocage réel s'applique.
...
`vethos_blocking*.json` sont migrés vers `C:\ProgramData\Vethos`.
