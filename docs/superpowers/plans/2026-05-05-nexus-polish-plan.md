...
Spec : [2026-05-05-nexus-polish-design.md](../specs/2026-05-05-nexus-polish-design.md)
...
- Preload : `nexus.appUsage.get()`, `nexus.appUsage.onTick(cb)` returns unsubscribe
...
- `npm run lint`
- `npm run build`
- Update `NEXUS_SPEC.md` (sous-projet 6 → ✅ Livré)
- Update mémoire `nexus_resume_state.md`
