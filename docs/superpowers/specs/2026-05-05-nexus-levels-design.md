# Nexus — Sous-projet 4 : Niveaux + distribution du temps libre
...
Persistance via storage générique sous `nexus_levels.json`.
...
8. ✅ NEXUS_SPEC.md mis à jour, tag `v0.4.0-levels`
