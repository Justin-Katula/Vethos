# Vethos — Registre des sites/apps et classification (« Calendrier vivant », couche 2)

## Contexte
Partie A + Partie B livrent le calendrier vivant. Cette couche 2 définit
**comment Vethos sait quoi bloquer** quand un bloc de tâche/objectif s'active.
...
bloquer pour chaque objectif, **Vethos apprend en regardant** : il scanne les
...
- Préreq : les bugs 2 et 3 (scan apps + historique) doivent être réparés
  (cf. `docs/superpowers/specs/2026-05-18-vethos-known-bugs-diagnostics.md`).
