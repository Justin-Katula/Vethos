...
const PAR_MOT_CLE: Array<[AppCategory, readonly string[]]> = [
  ...
  ['productivity', ['office', 'bureau', 'note', 'task', 'tâche', 'tache', 'todo', 'calendar', 'agenda', 'mail', 'code', 'develop', 'ide', 'terminal', 'sql', 'database', 'bank', 'banque', 'finance', 'compta', 'invoice', 'facture']],
  ...
  ['utilities', ['tool', 'outil', 'util', 'clean', 'backup', 'sauvegarde', 'compress', 'archive', 'zip', 'ftp', 'ssh', 'remote', 'vpn', 'antivirus', 'monitor', 'browser', 'navigateur']],
]
